...
public class PageResponseImpl implements PageResponse, Serializable{
	
	private static final long serialVersionUID = -2680449386419122740L;
	...
	public PageResponseImpl(List<OpcInfoRegisterMongo> content){
		this(content, null, null == content ? Long.valueOf(0) : content.size());
	}

	@SuppressWarnings("unchecked")
	public PageResponseImpl(List content, Pageable pageable, Long total) {
		if (null == content) {
	...
	@XmlElement(name="object", type=MongoLogger.class)
