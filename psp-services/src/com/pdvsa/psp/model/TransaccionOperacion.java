...
public class TransaccionOperacion implements Serializable{
	...
	public TransaccionOperacion(){}
	
	public TransaccionOperacion(Transaccion transaccion, Operacion operacion, Usuario usuario){
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TransaccionOperacion other = (TransaccionOperacion) obj;
		if (id == null) {
			if (other.id != null)
				return false;
